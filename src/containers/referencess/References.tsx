...
import { useDestroyReferenceMutation, useReferencesQuery } from '../../generated/graphql';
...
const References = () => {
  ...
  const { data, loading } = useReferencesQuery({variables: {filter: { name_cont: searchQuery }}})
